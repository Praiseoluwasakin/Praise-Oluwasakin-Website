          ...
          <section className="mb-12 md:mb-16">
            <div className="fixed-grid">
              <div className="col-span-4 md:col-span-10 md:col-start-2">
                <span className="font-body text-xs text-brand-accent uppercase tracking-widest font-semibold block mb-2">
                  E-Commerce & Frontend Chronicles
                </span>
                <h1 className="font-display text-3xl sm:text-4xl md:text-[56px] font-extrabold text-brand-navy mb-6 leading-[1.15] tracking-tight border-b border-architectural pb-6 md:pb-8">
                  The Storybook of E-Commerce Architectures
                </h1>
                <p className="font-body text-base md:text-lg text-brand-navy/80 max-w-3xl leading-relaxed">
                  Complex topics broken down through physical metaphors: car engines, rubber ducks, Lagos apartments, and Balogun storefronts. Learn how to construct high-converting digital environments—and why professional engineering holds the foundation.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {blogPosts.map((post) => (
                <article
                  ...
                  className="border border-architectural flex flex-col justify-between p-6 bg-brand-bg/40 hover:bg-brand-navy hover:text-brand-bg transition-all duration-300 group cursor-pointer"
                >
                  <div>
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-xs text-brand-navy/60 group-hover:text-brand-bg/50 flex items-center gap-1">
                        <Clock className="w-3.5 h-3.5" />
                        {post.readTime}
                      </span>
                    </div>

                    <h2 className="font-display text-xl md:text-2xl font-bold mb-3 group-hover:text-brand-bg transition-colors duration-300 leading-tight">
                      {post.title}
                    </h2>
                    
                    <p className="font-body text-sm text-brand-navy/85 group-hover:text-brand-bg/80 transition-colors duration-300 line-clamp-4 leading-relaxed mb-6">
                      {post.excerpt}
                    </p>
                  </div>

                  <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-brand-navy group-hover:text-brand-accent transition-colors pt-4 border-t border-architectural/50 group-hover:border-brand-bg/20 mt-auto">
